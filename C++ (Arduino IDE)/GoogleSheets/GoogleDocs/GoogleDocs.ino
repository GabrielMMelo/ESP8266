...
// VERSAO 1 https://script.google.com/macros/s/AKfycby11h5yqUE_W_GMujrVJByqR3x1MJrIOAQHrruxtFWX5fr5_g/exec?value=Hello
// VERSAO 2 https://script.google.com/macros/s/AKfycbz7mpxMC3ke5PXBps2v2VefJC9lGL56uP44AszXNQaSUGKOfNI/exec
const char* host = "script.google.com";
// Replace with your own script id to make server side changes
const char *GScriptId = "AKfycby11h5yqUE_W_GMujrVJByqR3x1MJrIOAQHrruxtFWX5fr5_g"; // VERSAO 1
//const char *GScriptId = "AKfycbz7mpxMC3ke5PXBps2v2VefJC9lGL56uP44AszXNQaSUGKOfNI"; // VERSAO 2

const int httpsPort = 443;

// echo | openssl s_client -connect script.google.com:443 |& openssl x509 -fingerprint -noout
const char* fingerprint = "12 D2 CD BF EA 6A 24 D2 B6 04 CA 2E DA A5 CA F9 4C 84 BE 7A";
float readSensor(){
  return digitalRead(4);
}
// Write to Google Spreadsheet
String url = String("/macros/s/") + GScriptId + "/exec?value="+ String(readSensor());
//String url = String("/macros/s/") + GScriptId + "/exec?value=noissehbao";
